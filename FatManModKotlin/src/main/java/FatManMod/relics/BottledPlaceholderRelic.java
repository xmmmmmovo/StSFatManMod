...
import FatManMod.patches.relics.BottledPlaceholderField;
import FatManMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static FatManMod.DefaultMod.makeRelicOutlinePath;
import static FatManMod.DefaultMod.makeRelicPath;
